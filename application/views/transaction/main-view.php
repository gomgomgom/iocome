...
<script type="text/javascript" src="<?php echo js_url();?>/Application/transaction.js"></script>

<div class="transaction" id="content-page-transaction">

	<div class="row">
		<div class="col-xs-6">
			<span class="subtitle-page">Transaction</span> &nbsp;
		...
		<div align="right" class="col-xs-6">
			<button type="button" class="btn btn-success btn-lg tooltip-info" data-placement="bottom" onClick="transaction.openFormAdd();" title="Show form input data">
